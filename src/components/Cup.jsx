    ...
    return (
      <React.Fragment>
        <div className="cup-top-right-buttons">
          <a href="#action" data-method="give" data-cup={ this.props.cupId } disabled={ !actions.free.give } onClick={ this.props.handleOpenDialog }>
          ...
          <a href="#action" data-method="shut" data-cup={ this.props.cupId } disabled={ !actions.free.shut } onClick={ this.props.handleOpenDialog }>
