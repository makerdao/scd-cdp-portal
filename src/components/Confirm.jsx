          ...
          <div className="row" style={ {border: "none"} }>
            <div className="col">
              ...
              <div>
                ...
                <button className="bright-style text-btn text-btn-primary" onClick={ () => {execute(); mixpanel.track('btn-click', { id: 'confirmCDP', collateral: eth, debt: dai });} } disabled={ !checkTerms }>FINALIZE AND CREATE CDP</button>
              </div>
            </div>
          </div>
        </div>
