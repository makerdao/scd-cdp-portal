  ...
  render() {
    return (
      ...
      <InlineNotification
        ...
        message="Your account has one or more existing CDPs from the old Sai Dashboard. You'll need to migrate these CDPs to the new CDP Portal to see and interact with them here. Once migrated, your CDPs will only be accesible via this CDP Portal."
        buttonText="Continue"
