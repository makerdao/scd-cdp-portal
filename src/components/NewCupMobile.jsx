    ...
    return (
      <div id="newCupMobile">
        ...
        <div className="row" style={ {borderBottom: "none", marginBottom: "40px"}}>
          <div className="col">
            <button className={"bright-style text-btn text-btn-primary-mobile"} onClick={() => mixpanel.track('btn-click', { id: 'collateralize_generate', mobile: true, product: 'scd-cdp-portal' })} type="submit" disabled={ !submitEnabled }>continue</button>
          </div>
        </div>
      </div>
    );
