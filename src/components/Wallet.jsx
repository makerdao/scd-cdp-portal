                                ...
                                Object.keys(tokens).map(token =>
                                  <tr key={ token }>
                                    ...
                                    <td>
                                      {
                                        token !== "eth" &&
                                        <ToggleSwitch enabled={ !this.props.system[token].allowance.eq(-1) } onClick={ e => { e.preventDefault(); this.props.system.setAllowance(token, !this.props.system[token].allowance.eq(BIGGESTUINT256)) } } on={ this.props.system[token].allowance.eq(BIGGESTUINT256) } pending={ this.props.transactions.loading.changeAllowance && this.props.transactions.loading.changeAllowance[token] } />
                                      }
                                    </td>
                                  </tr>
                                )
