  ...
  render() {
    return(
      <div>
        ...
        <p>
          If you believe that your copyright or the copyright of a person on whose behalf you are authorized to act has been infringed, please provide a written Notice (<a href="mailto:legal@makerdao.com">legal@makerdao.com</a>) containing the following information:
        </p>
        <ul>
        ...
        <p>
          Users with questions, complaints or claims with respect to the Service may contact us using the relevant contact information set forth above and at <a href="mailto:legal@makerdao.com">legal@makerdao.com</a>.
        </p>
        <h4>
          14. Prohibited Use
        </h4>
        <p>
          You may not use the Service to engage in the following categories of activity ("Prohibited Uses"). The specific types of use listed below are representative, but not exhaustive. If you are uncertain as to whether or not your use of the Services involves a Prohibited Use, or have questions about how these requirements apply to you, please contact us at <a href="mailto:legal@makerdao.com">legal@makerdao.com</a> By opening using the Service provided here, you confirm that you will not use this Service to do any of the following:
        </p>
        <ul>
